  ...
  return (
    <div className="flex-wrap flex items-center ">
      ...
      {endTime && (
        ...
        <b>  Ends Offer:</b>
          <div>
          <span className="ml-0 sm:ml-2 lg:ml-3 text-sm md:text-2xl bg-red-600 text-white px-3 py-1 rounded-sm  ">
            {formatTime(endTime).days}d   
          </span>
          <span className="ml-2 lg:ml-3 text-sm md:text-2xl bg-red-600 text-white px-3 py-1 rounded-sm ">
